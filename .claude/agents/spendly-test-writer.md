...
def auth_client(client):
    ...
    return client
```
Adapt fixtures to the actual Oxos Platform API as it exists — do not assume helpers beyond what the task describes.
...
**Update your agent memory** as you write tests for Oxos Platform features. This builds up institutional knowledge about the test suite across conversations. Write concise notes about what you discover.
