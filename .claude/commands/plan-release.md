...
Create a planning branch, stage everything under `.claude/features/`, commit, push, and open a PR to main.
...
gh pr create --title "plan: <feature_number> <title>" --body "Release plan and processed thought for feature <feature_number>. Auto-generated by /plan-release." --base main
```

After the PR is created, immediately merge it:
```
